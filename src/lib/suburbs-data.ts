// Drawbridge Commercial Capital - San Antonio neighborhood pages.
...
export const SUBURBS: Suburb[] = [
  {
    ...
    intro:
      "Downtown San Antonio is the city's tourism, hospitality and professional-services engine - anchored by the Riverwalk, the Convention Center, the Alamo and a deep base of law, accounting and consulting firms. Drawbridge Commercial Capital works with Downtown owners on hotel financing, restaurant working capital, professional-services lines and SBA acquisition deals tailored to event-driven cash flow.",
  ...
  },
  {
    ...
    intro:
      "The Pearl is San Antonio's chef-driven hospitality and boutique-retail district - built around the redeveloped Pearl Brewery, Hotel Emma and the Culinary Institute of America's San Antonio campus. Drawbridge Commercial Capital finances Pearl operators with restaurant working capital, hotel CapEx, equipment loans and inventory lines that respect the area's premium rent base.",
  ...
  },
  {
    ...
    intro:
      "Southtown is San Antonio's arts and creative district - King William mansions, the Blue Star Arts Complex, breweries and the chef-driven restaurants along South Alamo. Drawbridge Commercial Capital finances Southtown operators with restaurant working capital, brewery equipment loans and storefront build-out financing built for a tight rent base and event-driven sales.",
  ...
  },
  {
    ...
    intro:
      "San Antonio's Westside is the cultural and manufacturing heart of the city - a deep base of family-owned panaderías, auto shops, light manufacturers and trades along Guadalupe Street and Commerce. Drawbridge Commercial Capital works with Westside owners on equipment, real estate and SBA acquisition deals priced for legacy operators and second-generation owners.",
  ...
  },
  {
    ...
    intro:
      "South San Antonio is the industrial backbone of the city - anchored by the Toyota Texas truck plant, Port San Antonio (the redeveloped Kelly AFB), and a wide base of distribution, manufacturing and aerospace-adjacent suppliers. Drawbridge Commercial Capital finances South Side operators with equipment loans, AR factoring and SBA 504 industrial real estate.",
  ...
  },
  {
    ...
    intro:
      "The I-10 / Loop 1604 Northside corridor concentrates San Antonio's largest employers - USAA, Valero, the South Texas Medical Center and a thick base of tech-enabled professional services. Drawbridge Commercial Capital finances Northside operators with unsecured working capital, revenue-based financing and SBA expansion capital sized for white-collar businesses.",
  ...
  },
  {
    ...
    intro:
      "Schertz and Cibolo together form the I-35 NE distribution corridor between San Antonio and Austin - Amazon, Sysco, and a deep base of franchise food, trades and distribution operators serving the metro from the suburbs. Drawbridge Commercial Capital works with Schertz/Cibolo owners on equipment, franchise SBA 7(a) and revolving lines.",
